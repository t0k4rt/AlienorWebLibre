...
<html lang="fr">
<head>
<title>Formulaire de consultation : Lithoth&egrave;que</title>
...
<div id="haut">
    <h2>Formulaire de consultation Lithoth&egrave;que </h2>
</div>
<div id="s-menu">
...
<div id="formulaireIMG">
    ...
    <table cellpadding="3" cellspacing="0" class="centpcent">
        <tr>
            <td class="tddesignation">G&icirc;te&nbsp;(lieux&nbsp;de&nbsp;collecte,&nbsp;secteur&nbsp;g&eacute;ographique)&nbsp;:</td>
...
$i = 0 ;
	do {
        ...
        <tr>
            <td class="tddesignation">Descripteur&nbsp;:</td>
            <td class="tddonnees"> <?php
mysql_select_db($database_alienorweblibre, $alienorweblibre);
...
$i = 0;
	do {
        ...
        <tr>
            <td class="tddesignation">Contexte,&nbsp;pr&eacute;cision&nbsp;sur&nbsp;la&nbsp;collecte&nbsp;:</td>
            <td class="tddonnees"><?php echo $row_objets['PRECISION_DECOUVERTE']; ?></td>
        </tr>
        <tr>
            <td class="tddesignation">Date de collecte :</td>
        ...
        <tr>
            <td class="tddesignation">Collecteur :</td>
            <td class="tddonnees"> <?php
mysql_select_db($database_alienorweblibre, $alienorweblibre);
...
$i = 0;
	do {
        ...
        <tr>
            <td class="tddesignation">Type de collecte :</td>
    ...
    <table cellpadding="3" cellspacing="0" class="centpcent">
        <tr>
            <td class="tddesignation">Caract&egrave;res&nbsp;macroscopiques&nbsp;puis&nbsp;microscopiques&nbsp;:</td>
            <td class="tddonnees"><?php echo nl2br($row_objets['PRECISION_DESCRIPTION']); ?></td>
        </tr>
        <tr>
            <td class="tddesignation">D&eacute;terminateur&nbsp;:</td>
            <td class="tddonnees"><?php
mysql_select_db($database_alienorweblibre, $alienorweblibre);
...
$i = 0;
	do {
        ...
        <tr>
            <td class="tddesignation">Date&nbsp;de d&eacute;termination&nbsp;:</td>
            <td class="tddonnees"><?php echo $row_objets['DETERMINATEUR_TXT_DATE_PATRIMONIALE']; ?> <?php echo reverseDate($row_objets['DETERMINATEUR_DEB_DATE_PATRIMONIALE']); ?> et <?php echo reverseDate($row_objets['DETERMINATEUR_FIN_DATE_PATRIMONIALE']); ?></td>
        </tr>
        <tr>
            <td class="tddesignation">Taxonomie&nbsp;d&eacute;terminer&nbsp;:</td>
            <td class="tddonnees"><?php echo $row_objets['DETERMINATEUR_PARAM']; ?></td>
        </tr>
    </table>
    ...
    <table cellpadding="3" cellspacing="0" class="centpcent">
        <tr>
            <td height="22" class="tddesignation">Mill&eacute;naire :</td>
            <td class="tddonnees"><?php echo $row_objets['SIECLE_MILLENAIRE']; ?></td>
        </tr>
        <tr>
            <td class="tddesignation">Attribution&nbsp;g&eacute;ologique&nbsp;(&eacute;poque)&nbsp;:</td>
        ...
        <tr>
            <td class="tddesignation">Datation&nbsp;du&nbsp;contexte&nbsp;:</td>
            <td class="tddonnees"><?php echo $row_objets['DATATION_CONTEXTE']; ?></td>
        </tr>
    </table>
...
$i = 0;
	do {
		...
		$i++;
                ...
                <span class="tddesignation">Date d&#8217;entr&eacute;e dans collection :</span>&nbsp;<?php echo $row_objets['ANCIENNE_APPARTENANCE_TXT_DATE_PATRIMONIALE']; ?>&nbsp;<?php echo reverseDate($row_objets['ANCIENNE_APPARTENANCE_FIN_DATE_PATRIMONIALE']); ?>&nbsp;et&nbsp;<?php echo reverseDate($row_objets['ANCIENNE_APPARTENANCE_DEB_DATE_PATRIMONIALE']); ?> <br>
...
$i = 0 ;
	do {
		...
		echo $row_docum['IDENTIFIANT'];?> <?php if ($row_docum['INDEX_DOCUMENTATION'] != "") { ?> <a href="mc_documentation.php?noFiche=<?php echo $row_docum['INDEX_DOCUMENTATION'] ?>" target="_blank"><img src="../images/changer_base.gif"  alt="Voir le site internet" width="50" height="20" border="0" style="vertical-align:middle"></a> <?php } $i++;
                ...
                <span class="tddesignation">Lien :</span> <a href="<?php echo $row_objets['INTERNET_PARAM']; ?>" target="_blank"><?php echo $row_objets['INTERNET_PARAM']; ?></a> </td>
        </tr>
        <tr>
...
$i = 0 ;
    ...
    <table cellpadding="3" cellspacing="0" class="centpcent" >
        ...
        <tr>
            ...
            <td class="tddonnees"><?php echo $row_objets['CODEMUSEE']; $codeMusee = $row_objets['CODEMUSEE'];?></td>
        </tr>
    </table>
