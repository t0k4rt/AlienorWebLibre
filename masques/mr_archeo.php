...
<div id="haut">
    <h2>Formulaire de recherche Arch&eacute;ologie </h2>
</div>
<div id="s-menu">
...
<div id="formulaire">
    <form name="fiche" method="post" action="../masques/rep_<?php echo($page)?>.php">
        <!-- ZONE IDENTIFICATION -->
        ...
        <table cellpadding="3" cellspacing="0" class="centpcent" summary="identification">
            ...
            <tr>
                <td>
                    <input name="NUMERO_INVENTAIRE" type="text" class="motcles" id="NUMERO_INVENTAIRE">
                </td>
                <td>
                    <input name="DISCIPLINE" type="text" class="motcles" id="DISCIPLINE">
                </td>
                <td>
                    <input name="DOMAINE" type="text" class="motcles" id="DOMAINE">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <input name="DENOMINATION" type="text" class="motcles" id="DENOMINATION">
                </td>
                <td>
                    <input name="TITRE" type="text" class="motcles" id="TITRE">
                </td>
                <td>
                    <input name="APPELLATION" type="text" class="motcles" id="APPELLATION">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <input name="VERNACULAIRE" type="text" class="motcles" id="VERNACULAIRE">
                </td>
                <td>
                    <input name="NB_EXEMPLAIRE" type="text" class="motcles" id="NOMBRE_EXEMPLAIRE">
                </td>
                <td>
                    <input name="TYPOLOGIE" type="text" class="motcles" id="TYPOLOGIE">
                </td>
            </tr>
            <tr>
                <td><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=TAXO&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=TAXONOMIE');">
                    <span>Taxonomie</span>
                    </a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1110)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td>
                    <input name="TAXONOMIE" type="text" class="motcles" id="TAXONOMIE">
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
        ...
        <table cellpadding="3" cellspacing="0" class="centpcent">
            ...
            <tr>
                <td><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=MAT&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=MATIERE');">
                    <span>Mati&egrave;re</span>
                    </a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1301)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a></td>
                <td><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=TECHN&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=TECHNIQUE');">
                    <span>Technique</span>
                    </a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1309)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a></td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td>
                    <input name="MATIERE" type="text" class="motcles" id="mat">
                </td>
                <td>
