...
<html lang="fr">
<head>
<title>Formulaire de consultation : Vivant</title>
...
<div id="haut">
    <h2>Formulaire de consultation du Vivant </h2>
</div>
<div id="s-menu">
...
<div id="formulaireIMG">
    ...
    <table cellpadding="3" cellspacing="0" class="centpcent">
        <tr>
            <td class="tddesignation">Lieux de collecte :</td>
...
$i = 0;
	do {
        ...
        <tr>
            <td class="tddesignation">Pr&eacute;cision&nbsp;sur&nbsp;la&nbsp;d&eacute;couverte&nbsp;:</td>
    ...
    <table cellpadding="3" cellspacing="0" class="centpcent">
        ...
        <tr>
            <td class="tddesignation">Description, genre, note:</td>
...
$i = 0;
	...
	?> <span class="tddesignation">Auteur : </span> <?php
        ...
        <tr>
            <td class="tddesignation">Taxonomie&nbsp;d&eacute;termin&eacute;e&nbsp;: </td>
	...
	do {
        ...
        <tr>
            <td class="tddonnees"> <span class="tdtitre"><a name="objet_rapport"></a>Objets en rapport :</span><br>
                <?php
				$tableau = split("/",$row_objets['LIEN_INTRAOBJET']);	
