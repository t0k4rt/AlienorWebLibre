...
<html lang="fr">
<head>
<title>Formulaire de consultation : Bibliographie</title>
...
<div id="hautDoc">
    <h2>Masque g&eacute;n&eacute;ral de visualisation d&#8217;une bibliographie</h2>
</div>
<div id="s-menuDoc">
    <div id="menuDoc"><a href="#GENERALE">G&eacute;n&eacute;rale</a> <span class="invisible">|</span> <a href="#SUPPORT">Support</a> <span class="invisible">|</span> <a href="#LIVRE">Livre</a> <span class="invisible">|</span> <a href="#INFORMATIQUE">Gestion&nbsp;informatique</a></div>
</div>
...
<div id="formulaireDoc">
    ...
    <table cellpadding="3" cellspacing="0" class="centpcent">
        ...
        <tr>
            <td class="tddesignation">Auteur :</td>
...
$i = 0;
	...
	?><?php
        ...
        <tr>
            <td class="tddesignation">Titre du p&eacute;riodique:</td>
            <td class="tddonnees"><?php echo $row_docum['TITRE_DOCUMENT']; ?></td>
        </tr>
        <tr>
            <td class="tddesignation">&Eacute;diteur :</td>
            <td class="tddonnees"><?php
mysql_select_db($database_alienorweblibre, $alienorweblibre);
...
$i = 0 ;
	do {
        ...
        <tr>
            <td class="tddesignation">Date d&#8217;&eacute;dition ou d&#8217;exposition :</td>
        ...
        <tr>
            <td class="tddesignation">Description physique ou commentaires techniques :</td>
        ...
        <tr>
            <td class="tddesignation">Notes libres ou commentaires :</td>
    ...
    <table cellpadding="3" cellspacing="0" class="centpcent">
        ...
        <tr>
            <td class="tddesignation">Webmestre :</td>
            <td class="tddonnees"><?php
mysql_select_db($database_alienorweblibre, $alienorweblibre);
$query_auteur = "SELECT personne.INDEX_PERSONNE, ETAT_CIVIL FROM personne,doc_per WHERE doc_per.INDEX_DOCUMENTATION =".$noFiche." AND personne.INDEX_PERSONNE = doc_per.INDEX_PERSONNE AND doc_per.QUALIFIANT = 'WEBMESTRE' ORDER BY INDEX_DOC_PER ASC";
$auteur = mysql_query($query_auteur, $alienorweblibre) or die(mysql_error());
$row_auteur = mysql_fetch_assoc($auteur);
$totalRows_auteur = mysql_num_rows($auteur);
$i = 0;
    ...
    <table cellpadding="3" cellspacing="0" class="centpcent">
        <tr>
            <td class="tddesignation">Titre du p&eacute;riodique:</td>
            <td class="tddonnees"><?php echo $row_docum['TITRE_ENSEMBLE']; ?></td>
        </tr>
        <tr>
            <td class="tddesignation">ISBN :</td>
            <td class="tddonnees"><?php echo $row_docum['ISBN']; ?></td>
        </tr>
        <tr>
            <td class="tddesignation">ISSN :</td>
            <td class="tddonnees"><?php echo $row_docum['ISSN']; ?></td>
        </tr>
        <tr>
            <td class="tddesignation">Cote de l&#8217;Ouvrage :</td>
            <td class="tddonnees"><?php echo $row_docum['COTE']; ?></td>
        </tr>
    </table>
