...
/* Requète */
mysql_select_db($database_alienorweblibre, $alienorweblibre);
$query_objet = "SELECT INDEX_OBJET, DENOMINATION, TAXONOMIE, NUMERO_INVENTAIRE, LOCALISATION FROM objet ";
if ($vide == 0) {
...
?>
<div id="haut">
<h2>R&eacute;sultat d'une recherche avec le masque vivant </h2>
</div>
    ...
    <form name="Selection" action="rep_ethno.php">
        <table width="90%" style="border: 1px solid #666666" cellpadding="3">
            <tr>
                ...
                <th scope="col" width="23%">Nom commun </th>
                <th scope="col" width="23%">Taxonomie</th>
		...
		?>
                <tr>
                  ...
                  <td class="<?php echo $color; ?>"><?php echo $row_objet['TAXONOMIE']; ?></td>
