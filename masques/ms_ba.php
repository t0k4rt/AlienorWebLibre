...
<html lang="fr">
<head>
<title>Formulaire de saisie : Arts</title>
        ...
        <table cellpadding="3" cellspacing="0" class="centpcent">
            ...
            <tr>
                ...
                <td valign="top">Titre <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1104)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <textarea name="TITRE" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
                <td valign="top">&nbsp;</td>
            </tr>
        ...
        <table cellpadding="3" cellspacing="0" class="centpcent">
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=MAT&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=MATIERE');">Mati&egrave;re</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1301)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <textarea name="MATIERE" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=TECHN&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=THECHNIQUE');">Technique</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1309)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    <?php isset($_POST['TECHNIQUE']) ? $valeur = $_POST['TECHNIQUE'] : $valeur = $row_rech_objet['TECHNIQUE']; ?>
                    <textarea name="TECHNIQUE" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
                <td valign="top">&nbsp;</td>
            </tr>
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=ENCOM&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=ENCOMBREMENT');">Encombrement</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1310)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <textarea name="ENCOMBREMENT" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
                <td valign="top">Dimensions et forme <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1302)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <textarea name="DIMENSIONS_FORMES" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
                <td valign="top">&nbsp;</td>
            </tr>
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=TYPIN&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=TYPE_INSCRIPTION');">Type d&#8217;inscription</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1304)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <textarea name="TYPE_INSCRIPTION" rows="4" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
                <td valign="top">Transcription des inscriptions <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1305)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <textarea name="TRANSCRIPTION_INSCRIPTION" rows="4" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
                <td valign="top">Onomastique <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1306)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <textarea name="ONOMASTIQUE" rows="4" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
            </tr>
            <tr>
	...
	$i++;
            ...
            <tr valign="top">
                <td><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=AUT&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=ATTRIBUTION');">Attribution</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1416)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <?php
mysql_select_db($database_alienorweblibre, $alienorweblibre);
$query_auteur = "SELECT ETAT_CIVIL FROM personne,obj_per WHERE obj_per.INDEX_OBJET =".$noFiche." AND personne.INDEX_PERSONNE = obj_per.INDEX_PERSONNE AND obj_per.QUALIFIANT = 'ATTRIBUTION' ORDER BY INDEX_OBJ_PER ASC";
$auteur = mysql_query($query_auteur, $alienorweblibre) or die(mysql_error());
$row_auteur = mysql_fetch_assoc($auteur);
$totalRows_auteur = mysql_num_rows($auteur);
$i = 0 ;
...
do {
	...
	$result .= $row_auteur['ETAT_CIVIL'];
	$i++;
} while ($row_auteur = mysql_fetch_assoc($auteur)); ?> <?php isset($_POST['ATTRIBUTION']) ? $valeur = $_POST['ATTRIBUTION'] : $valeur = $result; ?>
                    <input name="ATTRIBUTION" class="inputlong40" type="text" value="<?php echo stripslashes($valeur)?>">
                </td>
                <td><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=AUT&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=ATTRIBUTEUR');">Attributeur</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1417)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    <?php
mysql_select_db($database_alienorweblibre, $alienorweblibre);
$query_auteur = "SELECT ETAT_CIVIL FROM personne,obj_per WHERE obj_per.INDEX_OBJET =".$noFiche." AND personne.INDEX_PERSONNE = obj_per.INDEX_PERSONNE AND obj_per.QUALIFIANT = 'ATTRIBUTEUR' ORDER BY INDEX_OBJ_PER ASC";
$auteur = mysql_query($query_auteur, $alienorweblibre) or die(mysql_error());
$row_auteur = mysql_fetch_assoc($auteur);
$totalRows_auteur = mysql_num_rows($auteur);
$i = 0 ;
...
do {
	...
	$result .= $row_auteur['ETAT_CIVIL'];
	$i++;
} while ($row_auteur = mysql_fetch_assoc($auteur)); ?> <?php isset($_POST['ATTRIBUTEUR']) ? $valeur = $_POST['ATTRIBUTEUR'] : $valeur = $result; ?>
                    <input name="ATTRIBUTEUR" class="inputlong40" type="text" value="<?php echo stripslashes($valeur)?>">
                </td>
                <td>Date d&#8217;attribution <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1418)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a>
                    <table cellspacing="0">
                        <tr>
                            <td>Affixe</td>
                        ...
                        <tr>
                            <td> <?php isset($_POST['TXT_DATE_ATTRIBUTION']) ? $valeur = $_POST['TXT_DATE_ATTRIBUTION'] : $valeur = $row_rech_objet['TXT_DATE_ATTRIBUTION']; ?>
                                <input name="TXT_DATE_ATTRIBUTION" type="text" class="inputnumerique" value="<?php echo stripslashes($valeur)?>">
                            </td>
                            <td> <?php isset($_POST['DEB_DATE_ATTRIBUTION']) ? $valeur = $_POST['DEB_DATE_ATTRIBUTION'] : $valeur = $row_rech_objet['DEB_DATE_ATTRIBUTION']; ?>
                                <input name="DEB_DATE_ATTRIBUTION" type="text" class="inputnumerique" value="<?php echo stripslashes($valeur)?>">
                            </td>
                            <td>et</td>
                            <td> <?php isset($_POST['FIN_DATE_ATTRIBUTION']) ? $valeur = $_POST['FIN_DATE_ATTRIBUTION'] : $valeur = $row_rech_objet['FIN_DATE_ATTRIBUTION']; ?>
                                <input name="FIN_DATE_ATTRIBUTION" type="text" class="inputnumerique" value="<?php echo stripslashes($valeur)?>">
                            </td>
                        </tr>
                    </table>
                </td>
	...
	$i++;
            ...
            <tr>
                <td valign="top"> <?php isset($_POST['SIECLE_MILLENAIRE']) ? $valeur = $_POST['SIECLE_MILLENAIRE'] : $valeur = $row_rech_objet['SIECLE_MILLENAIRE']; ?>
                    <textarea name="SIECLE_MILLENAIRE" rows="2" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
                <td valign="top">
            ...
            <tr>
                <td colspan="3" valign="top"> <?php isset($_POST['PRECISION_GENESE']) ? $valeur = $_POST['PRECISION_GENESE'] : $valeur = $row_rech_objet['PRECISION_GENESE']; ?>
                    ...
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td> <?php isset($_POST['DEB_DATE_REPRESENTATION']) ? $valeur = $_POST['DEB_DATE_REPRESENTATION'] : $valeur = $row_rech_objet['DEB_DATE_REPRESENTATION']; ?>
                                <input name="DEB_DATE_REPRESENTATION" type="text" class="inputnumerique" value="<?php echo stripslashes($valeur)?>">
                            </td>
                            <td>et</td>
                            <td> <?php isset($_POST['FIN_DATE_REPRESENTATION']) ? $valeur = $_POST['FIN_DATE_REPRESENTATION'] : $valeur = $row_rech_objet['FIN_DATE_REPRESENTATION']; ?>
                                <input name="FIN_DATE_REPRESENTATION" type="text" class="inputnumerique" value="<?php echo stripslashes($valeur)?>">
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                ...
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=EPOQU&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=DATATION_CONTEXTE');">Datation du contexte</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1415)"><img src="../images/infos.gif" alt="Aide en ligne" width="16" height="16" border="0" style="vertical-align:middle"></a></td>
                <td valign="top">&nbsp;</td>
            </tr>
            <tr>
                <td valign="top">
                ...
                <td valign="top"> <?php isset($_POST['DATATION_CONTEXTE']) ? $valeur = $_POST['DATATION_CONTEXTE'] : $valeur = $row_rech_objet['DATATION_CONTEXTE']; ?>
                    <textarea name="DATATION_CONTEXTE" rows="2" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
                <td valign="top">&nbsp;</td>
            </tr>
...
$totalRows_auteur = mysql_num_rows($auteur);
?>
                    <input name="UTILISATEUR" class="inputlong40" type="text" value="<?php
					$i = 0 ;
					do {
						if ($i !=0 ) {
							echo "/";
                    ...
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>Date d&eacute;but<br>
                                ...
                                <input name="ANCIENNE_APPARTENANCE_DEB_DATE_PATRIMONIALE" type="text" class="inputnumerique" value="<?php echo stripslashes($valeur)?>">
                            </td>
                            <td valign="bottom">et</td>
                            <td>Date fin<br>
                                ...
                                <input name="ANCIENNE_APPARTENANCE_FIN_DATE_PATRIMONIALE" type="text" class="inputnumerique" value="<?php echo stripslashes($valeur)?>">
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>Date d&eacute;but<br>
                                ...
                                <input name="COMMISSAIRE_PRISEUR_DEB_DATE_PATRIMONIALE" type="text" class="inputnumerique" value="<?php echo stripslashes($valeur)?>">
                            </td>
                            <td valign="bottom">et</td>
                            <td>Date fin<br>
                                ...
                                <input name="COMMISSAIRE_PRISEUR_FIN_DATE_PATRIMONIALE" type="text" class="inputnumerique" value="<?php echo stripslashes($valeur)?>">
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>Date d&eacute;but<br>
                                ...
                                <input name="GALERIE_DEB_DATE_PATRIMONIALE" type="text" class="inputnumerique" value="<?php echo stripslashes($valeur)?>">
                            </td>
                            <td valign="bottom">et</td>
                            <td >Date fin<br>
                                ...
                                <input name="GALERIE_FIN_DATE_PATRIMONIALE" type="text" class="inputnumerique" value="<?php echo stripslashes($valeur)?>">
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>Date d&eacute;but<br>
                                ...
                                <input name="DEPOSITAIRE_DEB_DATE_PATRIMONIALE" type="text" class="inputnumerique" value="<?php echo stripslashes($valeur)?>">
                            </td>
                            <td valign="bottom">et</td>
                            <td>Date fin<br>
                                ...
                                <input name="DEPOSITAIRE_FIN_DATE_PATRIMONIALE" type="text" class="inputnumerique" value="<?php echo stripslashes($valeur)?>">
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>Date d&eacute;but<br>
                                ...
                                <input name="ANCIEN_DEPOSITAIRE_DEB_DATE_PATRIMONIALE" type="text" class="inputnumerique" value="<?php echo stripslashes($valeur)?>" maxlength="10">
                            </td>
                            <td valign="bottom">et</td>
                            <td>Date fin<br>
                                ...
                                <input name="ANCIEN_DEPOSITAIRE_FIN_DATE_PATRIMONIALE" type="text" class="inputnumerique" value="<?php echo stripslashes($valeur)?>" maxlength="10">
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <table border="0" cellspacing="0" class="centpcent">
            <tr>
                <td valign="top">Copyright <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1902)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <?php if ($noFiche != 0) { ?>
                    <textarea name="COPYRIGHT" rows="3" class="textarealong40"><?php echo $row_rech_objet['COPYRIGHT']?></textarea>
                    <?php } else { ?>
