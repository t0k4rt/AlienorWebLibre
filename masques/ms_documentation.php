...
<html lang="fr">
<head>
<title>Formulaire de saisie : Documentation g&eacute;n&eacute;rale</title>
...
<div id="hautDoc">
    <h2>Formulaire de saisie Documentation </h2>
</div>
<div id="s-menuDoc">
    <div id="menuDoc"><a href="#GENERALE">G&eacute;n&eacute;rale</a> <span class="invisible">|</span> <a href="#SUPPORT">Support</a> <span class="invisible">|</span> <a href="#PHOTO">Photographie</a> <span class="invisible">|</span> <a href="#LIVRE">Livre</a> <span class="invisible">|</span> <a href="#INFORMATIQUE">Gestion&nbsp;informatique</a>
...
<div id="formulaireDoc" class="saisie">
        ...
        <table align="center" class="centpcent">
            <tr>
                <td>
                    <p align="justify" class="tddesignation"><em><strong>NDLR :</strong></em></p>
                    ...
                    <p align="justify"><em>Pour une facilit&eacute; de compr&eacute;hension certaines rubriques ont des intitul&eacute;s assez long.</em></p>                </td>
            </tr>
        </table>
        <br>
        ...
        <table cellspacing="0" class="centpcent">
            <tr>
                <td valign="top">
                    <label for="" class="obligatoire"><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=TYDOC&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=TYPE_DOCUMENT');">Type de document</a></label>
                    ...
                    <input name="TYPE_DOCUMENT" class="inputlong40" value="<?php echo stripslashes($valeur)?>">                </td>
                <td valign="top">
                    ...
                    <input name="IDENTIFIANT_INIT" type="hidden" value="<?php echo $num_ini ?>">                </td>
            </tr>
            <tr valign="top">
...
do {
	...
	$i++;
            ...
            <tr valign="top">
                <td>Titre du document ou de l&#8217;exposition <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4102)"><img src="../images/infos.gif" alt="Aide en ligne" width="16" height="16" border="0" style="vertical-align:middle"></a><br>
                    <?php isset($_POST['TITRE_DOCUMENT']) ? $valeur = $_POST['TITRE_DOCUMENT'] : $valeur = $row_rech_docum['TITRE_DOCUMENT']; ?>
                    <textarea name="TITRE_DOCUMENT" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>                </td>
                <td valign="top">&nbsp;</td>
            </tr>
            <tr valign="top">
                <td><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=AUT&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=AUTEUR');">Auteur ou commissaire</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1413)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    <br>
                    <?php
mysql_select_db($database_alienorweblibre, $alienorweblibre);
...
do {
	...
	$i++;
                    ...
                    <input name="AUTEUR" class="inputlong40" type="text" value="<?php echo stripslashes($valeur)?>">                </td>
                <td>&nbsp;</td>
            </tr>
            <tr valign="top">
                <td><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=AUT&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=EDITEUR');">&Eacute;diteur ou organisateur</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4107)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    <br>
                    <?php
mysql_select_db($database_alienorweblibre, $alienorweblibre);
...
do {
	...
	$i++;
                    ...
                    <input name="EDITEUR" class="inputlong40" type="text" value="<?php echo stripslashes($valeur)?>">                </td>
                <td>&nbsp;</td>
            </tr>
            <tr valign="top">
                <td>
                    <table cellspacing="0">
                        ...
                        <tr>
                            <td>Affixe<br>
                                ...
                                <input name="TXTDATEEDITION" type="text" class="inputnumerique" value="<?php echo stripslashes($valeur)?>">                            </td>
                            <td>Date d&eacute;but<br>
                                <?php isset($_POST['DEBDATEEDITION']) ? $valeur = $_POST['DEBDATEEDITION'] : $valeur = $row_rech_docum['DEBDATEEDITION']; ?>
                                <input name="DEBDATEEDITION" type="text" class="inputnumerique" value="<?php echo stripslashes($valeur)?>">                            </td>
                            <td valign="bottom">et</td>
                            <td>Date fin<br>
                                <?php isset($_POST['FINDATEEDITION']) ? $valeur = $_POST['FINDATEEDITION'] : $valeur = $row_rech_docum['FINDATEEDITION']; ?>
                                <input name="FINDATEEDITION" type="text" class="inputnumerique" value="<?php echo stripslashes($valeur)?>">                            </td>
                        </tr>
                    </table>
                <td>&nbsp;</td>
                </td>
            ...
            <tr>
                <td valign="top">Collection <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4111)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    ...
                    <textarea name="COLLECTION" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>                </td>
                <td valign="top">&nbsp;</td>
            </tr>
            <tr>
                <td colspan="2" valign="top">Notes libres ou commentaires <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4104)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    ...
                    <textarea name="NOTE_LIBRE" rows="3" class="textarealong90"><?php echo stripslashes($valeur)?></textarea>                </td>
            </tr>
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=DTECH&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=DESCRIPTION_TECHNIQUE');">Description technique</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4105)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    ...
                    <textarea name="DESCRIPTION_TECHNIQUE" rows="4" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>                </td>
                <td valign="top">Commentaires&nbsp;techniques&nbsp;ou&nbsp;description&nbsp;physique&nbsp;<a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4106)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    ...
                    <textarea name="COMMENTAIRE_TECHNIQUE" rows="4" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>                </td>
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=PERIO&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=PERIODE_CONCERNE');">P&eacute;riode concern&eacute;e par le document</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4110)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    ...
                    <textarea name="PERIODE_CONCERNE" rows="2" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>                </td>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=MOCLE&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=MOTS_CLES');">Mots Cl&eacute;s</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4112)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    ...
                    <textarea name="MOTS_CLES" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>                </td>
            </tr>
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=DROIT&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=TYPE_DROIT');">Type de Droits</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4115)"><img src="../images/infos.gif" alt="Aide en ligne" width="16" height="16" border="0" style="vertical-align:middle"></a><br>
                    ...
                    <textarea name="TYPE_DROIT" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>                </td>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=ACCESS&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=ACCESSIBILITE');">Accessibilit&eacute;</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4114)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    ...
                    <textarea name="ACCESSIBILITE" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>                </td>
            </tr>
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=TLIEU&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=LOCALISATION_DOCUMENT');">Localisation</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4113)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    ...
                    <textarea name="LOCALISATION_DOCUMENT" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>                </td>
                <td valign="top">&nbsp;</td>
            </tr>
        </table>
        <br>
        ...
        <table cellpadding="3" cellspacing="0" class="centpcent">
            <tr>
                <td>Num&eacute;ro de Support.<a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4215)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    ...
                    <textarea name="NUMERO_SUPPORT" rows="2" class="textarealong20"><?php echo stripslashes($valeur)?></textarea>                </td>
                <td>Pr&eacute;cision ou adresse sur le Support <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4216)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    <br>
                    <?php isset($_POST['LOCALISATION_DOCUMENT']) ? $valeur = $_POST['LOCALISATION_DOCUMENT'] : $valeur = $row_rech_docum['LOCALISATION_DOCUMENT']; ?>
                    <textarea name="PRECISION_SUPPORT" cols="30" rows="2"><?php echo stripslashes($valeur)?></textarea>                </td>
                <td><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=AUT&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=WEBMESTRE');">Webmestre</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,7777)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    ...
                    <?php
mysql_select_db($database_alienorweblibre, $alienorweblibre);
$query_auteur = "SELECT ETAT_CIVIL FROM personne,doc_per WHERE doc_per.INDEX_DOCUMENTATION =".$noFiche." AND personne.INDEX_PERSONNE = doc_per.INDEX_PERSONNE AND doc_per.QUALIFIANT = 'WEBMESTRE' ORDER BY INDEX_DOC_PER ASC";
$auteur = mysql_query($query_auteur, $alienorweblibre) or die(mysql_error());
$row_auteur = mysql_fetch_assoc($auteur);
$totalRows_auteur = mysql_num_rows($auteur);
$i = 0 ;
...
do {
	...
	$result .= $row_auteur['ETAT_CIVIL'];
	$i++;
} while ($row_auteur = mysql_fetch_assoc($auteur)); ?> <?php isset($_POST['WEBMESTRE']) ? $valeur = $_POST['WEBMESTRE'] : $valeur = $result; ?>
                    <input name="WEBMESTRE" class="inputlong40" type="text" value="<?php echo stripslashes($valeur)?>">
              </td>
            </tr>
            <tr>
...
do {
	...
	$i++;
                    ...
                    <input name="PHOTOGRAPHE" class="inputlong40" type="text" value="<?php echo stripslashes($valeur)?>">                </td>
                <td valign="top">Num&eacute;ro d&#8217;inventaire du document dans le mus&eacute;e <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4122)"><img src="../images/infos.gif" alt="Aide en ligne" width="16" height="16" border="0" style="vertical-align:middle"></a><br>
                    ...
                    <input name="NUMERO_INVENTAIRE_INTERNE" type="text" class="inputlong40" value="<?php echo stripslashes($valeur)?>">                </td>
            </tr>
            <tr valign="top">
...
do {
	...
	$i++;
                    ...
                    <input name="LIEU_PRISE_VUE" class="inputlong40" type="text" value="<?php echo stripslashes($valeur)?>">                </td>
                <td>
                        ...
                        <tr>
                            <td> <?php isset($_POST['TXT_DATE_PRISE_VUE']) ? $valeur = $_POST['TXT_DATE_PRISE_VUE'] : $valeur = $row_rech_docum['TXT_DATE_PRISE_VUE']; ?>
                                <select name="TXT_DATE_PRISE_VUE">
                                    ...
                                    <option value="apr�s"<?php if ($valeur == "apr�s") {?> selected<?php ;} ?>>Apr&egrave;s</option>
                                    <option value="entre"<?php if ($valeur == "entre") {?> selected<?php ;} ?>>Entre</option>
                                    <option value="ann�e"<?php if ($valeur == "ann�e") {?> selected<?php ;} ?>>Ann&eacute;e</option>
                            ...
                            <td> <?php isset($_POST['DEB_DATE_PRISE_VUE']) ? $valeur = $_POST['DEB_DATE_PRISE_VUE'] : $valeur = $row_rech_docum['DEB_DATE_PRISE_VUE']; ?>
                                <input name="DEB_DATE_PRISE_VUE" type="text" class="inputnumerique" onBlur="champDat(this);" value="<?php echo reverseDate($valeur)?>">                            </td>
                            <td>et</td>
                            <td> <?php isset($_POST['FIN_DATE_PRISE_VUE']) ? $valeur = $_POST['FIN_DATE_PRISE_VUE'] : $valeur = $row_rech_docum['FIN_DATE_PRISE_VUE']; ?>
                                <input name="FIN_DATE_PRISE_VUE" type="text" class="inputnumerique" onBlur="champDat(this);" value="<?php echo reverseDate($valeur)?>">                            </td>
                        </tr>
                    </table>                </td>
            <tr valign="top">
                <td colspan="2">L&eacute;gende <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4323)"><img src="../images/infos.gif" alt="Aide en ligne" width="16" height="16" border="0" style="vertical-align:middle"></a><br>
                    ...
                    <textarea name="LEGENDE" cols="55" rows="4"><?php echo stripslashes($valeur)?></textarea>                </td>
            </tr>
            <tr valign="top">
                <td>Copyright de la photo <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4321)"><img src="../images/infos.gif" alt="Aide en ligne" width="16" height="16" border="0" style="vertical-align:middle"></a><br>
                    ...
                    <textarea name="COPYRIGHT_PHOTO" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>                </td>
                <td>&nbsp;</td>
            </tr>
        </table>
        ...
        <table class="centpcent">
            <tr valign="top">
                <td colspan="3">Titre d'ensemble <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4425)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    <br>
                    <?php isset($_POST['TITRE_ENSEMBLE']) ? $valeur = $_POST['TITRE_ENSEMBLE'] : $valeur = $row_rech_docum['TITRE_ENSEMBLE']; ?>
                    <textarea name="TITRE_ENSEMBLE" rows="3" class="textarealong90"><?php echo stripslashes($valeur)?></textarea>                </td>
            </tr>
            <tr valign="top">
                <td>ISBN <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4426)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a> <br>
                    <br>
                    <?php isset($_POST['ISBN']) ? $valeur = $_POST['ISBN'] : $valeur = $row_rech_docum['ISBN']; ?>
                    <input name="ISBN" id="ISBN" type="text" size="20" value="<?php echo stripslashes($valeur)?>">                </td>
                <td>ISSN <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4427)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    <br>
                    <?php isset($_POST['ISSN']) ? $valeur = $_POST['ISSN'] : $valeur = $row_rech_docum['ISSN']; ?>
                    <input name="ISSN" id="ISSN" type="text" size="20" value="<?php echo stripslashes($valeur)?>">                </td>
                <td>Cote de l&#8217;ouvrage <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4428)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    <br>
                    <?php isset($_POST['COTE']) ? $valeur = $_POST['COTE'] : $valeur = $row_rech_docum['COTE']; ?>
                    <input name="COTE" id="COTE" type="text" size="20" value="<?php echo stripslashes($valeur)?>">                </td>
            </tr>
        </table>
