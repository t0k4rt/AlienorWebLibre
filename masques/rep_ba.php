...
/* Requète */
mysql_select_db($database_alienorweblibre, $alienorweblibre);
$query_objet = "SELECT INDEX_OBJET, TITRE, DENOMINATION, NUMERO_INVENTAIRE, LOCALISATION FROM objet ";
if ($vide == 0) {
...
?>
<div id="haut">
<h2>R&eacute;sultat d'une recherche avec le masque Arts </h2>
</div>
    ...
    <form name="Selection" action="rep_ba.php">
		...
		?>
                <tr>
                    ...
                    <td class="<?php echo $color; ?>"><?php echo $row_objet['TITRE']; ?></td>
