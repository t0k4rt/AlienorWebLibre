...
<html lang="fr">
<head>
<title>Formulaire de saisie : Ethnographie</title>
...
<div id="haut">
    <h2>Formulaire de saisie Ethnographie</h2>
</div>
<div id="s-menu">
...
<div id="formulaire" class="saisie">
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="fiche" target="_self" id="fiche">
      <p class="titre">D&Eacute;SIGNATION </p>
        ...
        <table cellpadding="3" cellspacing="0" class="centpcent">
            <tr>
                <td valign="top"><span class="obligatoire">Num&eacute;ro d&#8217;inventaire</span> <a href="#" onClick="RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1109)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    <?php isset($_POST['NUMERO_INVENTAIRE']) ? $valeur = $_POST['NUMERO_INVENTAIRE'] : $valeur = $row_rech_objet['NUMERO_INVENTAIRE']; ?>
                    <input name="NUMERO_INVENTAIRE" type="text" class="motcles champobligatoire" value="<?php echo stripslashes($valeur)?>">
                ...
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=DSCP&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=DISCIPLINE');"><span class="obligatoire">Discipline</span></a> <a href="#" onClick="RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1101)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                  ...
                  <?php isset($_POST['DISCIPLINE']) ? $valeur = $_POST['DISCIPLINE'] : $valeur = $row_rech_objet['DISCIPLINE']; ?>
                    <input name="DISCIPLINE" id="DISCIPLINE" type="text" class="motcles champobligatoire" value="<?php echo stripslashes($valeur)?>">
                </td>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=DOMN&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=DOMAINE');"><span class="obligatoire">Domaine</span></a> <a href="#" onClick="RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1102)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <input name="DOMAINE" type="text" class="motcles champobligatoire" value="<?php echo stripslashes($valeur)?>">
                </td>
            </tr>
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=DENO&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=DENOMINATION');">D&eacute;nomination</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1103)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <input name="DENOMINATION" type="text" class="motcles" value="<?php echo stripslashes($valeur)?>">
                </td>
                <td valign="top">Titre <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1104)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    <?php isset($_POST['TITRE']) ? $valeur = $_POST['TITRE'] : $valeur = $row_rech_objet['TITRE']; ?>
                    <textarea name="TITRE" cols="10" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>
                </td>
            ...
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=TYPOL&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=TYPOLOGIE');">Typologie</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1108)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <textarea name="TYPOLOGIE" cols="10" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>
                </td>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=APPEL&amp;curterm=&amp;curindex=&amp;SRC=APPELLATION&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=APPELATION');">Appellation</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1105)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    <?php isset($_POST['APPELLATION']) ? $valeur = $_POST['APPELLATION'] : $valeur = $row_rech_objet['APPELLATION']; ?>
                    <textarea name="APPELLATION" cols="10" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>
                </td>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=VERNA&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=VERNACULAIRE');">Appellation vernaculaire</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1106)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    <?php isset($_POST['VERNACULAIRE']) ? $valeur = $_POST['VERNACULAIRE'] : $valeur = $row_rech_objet['VERNACULAIRE']; ?>
                    <textarea name="VERNACULAIRE" cols="10" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>
                </td>
            </tr>
        </table>
...
do {
	...
	$i++;
            ...
            <input name="LIEUX_DECOUVERTE" class="inputlong40" type="text" value="<?php echo stripslashes($valeur)?>">
            </td>
            
          </tr>
            
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=TYPCO&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=TYPE_COLLECTE');">Type de collecte</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1205)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    <?php isset($_POST['TYPE_COLLECTE']) ? $valeur = $_POST['TYPE_COLLECTE'] : $valeur = $row_rech_objet['TYPE_COLLECTE']; ?>
                    <textarea name="TYPE_COLLECTE" cols="10" rows="1" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>
                </td>
                <td valign="top">
                    <table cellpadding="0" cellspacing="0">
                        <tr valign="top">
                            <td colspan="4">Date de collecte <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1202)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a></td>
                        </tr>
                        <tr>
            ...
            <tr>
                <td colspan="2" valign="top">Pr&eacute;cision sur la collecte <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1203)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    <?php isset($_POST['PRECISION_DECOUVERTE']) ? $valeur = $_POST['PRECISION_DECOUVERTE'] : $valeur = $row_rech_objet['PRECISION_DECOUVERTE']; ?>
                    <textarea name="PRECISION_DECOUVERTE" cols="10" rows="5" class="textarealong60"><?php echo stripslashes($valeur)?></textarea>
                </td>
                <td valign="top" colspan="2"><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=AUT&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=COLLECTEUR');">Collecteur</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1206)"><img src="../images/infos.gif" alt="Aide en ligne" width="16" height="16" border="0" style="vertical-align:middle"></a><br>
                    <br>
                    <?php
mysql_select_db($database_alienorweblibre, $alienorweblibre);
$query_auteur = "SELECT ETAT_CIVIL FROM personne,obj_per WHERE obj_per.INDEX_OBJET =".$noFiche." AND personne.INDEX_PERSONNE = obj_per.INDEX_PERSONNE AND obj_per.QUALIFIANT = 'COLLECTEUR' ORDER BY INDEX_OBJ_PER ASC";
...
do {
	...
	$i++;
} while ($row_auteur = mysql_fetch_assoc($auteur)); ?> <?php isset($_POST['COLLECTEUR']) ? $valeur = $_POST['COLLECTEUR'] : $valeur = $result; ?>
                    <input name="COLLECTEUR" class="inputlong40" type="text" value="<?php echo stripslashes($valeur)?>">
                </td>
            </tr>
        </table>
        ...
        <table cellpadding="3" cellspacing="0" class="centpcent">
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=MAT&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=MATIERE');">Mati&egrave;re</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1301)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <textarea name="MATIERE" cols="10" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>
                </td>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=TECHN&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=TECHNIQUE');"><span>Technique</span></a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1309)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <textarea name="TECHNIQUE" cols="10" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>
                </td>
                <td valign="top">&nbsp;</td>
            </tr>
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=ENCOM&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=ENCOMBREMENT');">Encombrement</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1310)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    <?php isset($_POST['ENCOMBREMENT']) ? $valeur = $_POST['ENCOMBREMENT'] : $valeur = $row_rech_objet['ENCOMBREMENT']; ?>
                    <textarea name="ENCOMBREMENT" cols="10" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>
                </td>
                <td valign="top">Dimensions et forme <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1302)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    <?php isset($_POST['DIMENSIONS_FORMES']) ? $valeur = $_POST['DIMENSIONS_FORMES'] : $valeur = $row_rech_objet['DIMENSIONS_FORMES']; ?>
                    <textarea name="DIMENSIONS_FORMES" cols="10" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>
                </td>
                <td valign="top">&nbsp;</td>
            </tr>
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=TYPIN&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=TYPE_INSCRIPTION');">Type d&#8217;inscription</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1304)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <textarea name="TYPE_INSCRIPTION" cols="10" rows="4" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
                <td valign="top">Transcription des inscriptions <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1305)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    ...
                    <textarea name="TRANSCRIPTION_INSCRIPTION" cols="10" rows="4" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
                <td valign="top">Onomastique <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1306)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    <?php isset($_POST['ONOMASTIQUE']) ? $valeur = $_POST['ONOMASTIQUE'] : $valeur = $row_rech_objet['ONOMASTIQUE']; ?>
                    <textarea name="ONOMASTIQUE" cols="10" rows="4" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
            </tr>
            <tr>
                <td colspan="3" valign="top">Description <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1308)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <textarea name="PRECISION_DESCRIPTION" cols="10" rows="5" class="textarealong90"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
            </tr>
            <tr>
                <td colspan="3" valign="top"><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=REPDC&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=REPRESENTATION_DECOR');">Repr&eacute;sentation et d&eacute;cor</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1307)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <textarea name="REPRESENTATION_DECOR" cols="10" rows="5" class="textarealong90"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
            </tr>
        </table>
	...
	$i++;
            ...
            <tr>
                <td valign="top"> <?php isset($_POST['SIECLE_MILLENAIRE']) ? $valeur = $_POST['SIECLE_MILLENAIRE'] : $valeur = $row_rech_objet['SIECLE_MILLENAIRE']; ?>
                    <textarea name="SIECLE_MILLENAIRE" cols="10" rows="2" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>
                </td>
                <td valign="top">
                    <table cellpadding="0" cellspacing="0">
                        <tr>
            ...
            <tr>
                <td valign="top"> <?php isset($_POST['PRECISION_DATATION']) ? $valeur = $_POST['PRECISION_DATATION'] : $valeur = $row_rech_objet['PRECISION_DATATION']; ?>
                    <textarea name="PRECISION_DATATION" cols="10" rows="4" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
                <td valign="top"> <?php isset($_POST['EPOQUE_STYLE']) ? $valeur = $_POST['EPOQUE_STYLE'] : $valeur = $row_rech_objet['EPOQUE_STYLE']; ?>
                    <textarea name="EPOQUE_STYLE" cols="10" rows="4" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
            </tr>
            <tr>
                <td valign="top">Pr&eacute;cision sur la gen&egrave;se <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1405)"><img src="../images/infos.gif" alt="Aide en ligne" width="16" height="16" border="0" style="vertical-align:middle"></a></td>
                <td valign="top">&nbsp;</td>
            </tr>
            <tr>
                <td colspan="2" valign="top"> <?php isset($_POST['PRECISION_GENESE']) ? $valeur = $_POST['PRECISION_GENESE'] : $valeur = $row_rech_objet['PRECISION_GENESE']; ?>
                    <textarea name="PRECISION_GENESE" cols="10" rows="3" class="textarealong90"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td valign="top"> <?php isset($_POST['SOURCE_ORALE_ECRITE']) ? $valeur = $_POST['SOURCE_ORALE_ECRITE'] : $valeur = $row_rech_objet['SOURCE_ORALE_ECRITE']; ?>
                    <textarea name="SOURCE_ORALE_ECRITE" cols="10" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
                <td valign="top">
                    <table cellpadding="0" cellspacing="0">
                        <tr>
                            <td><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=AFFIXEDATE&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=TXT_DATE_REPRESENTATION');">Affixe</a></td>
                            <td>Date d&eacute;but</td>
                            <td>&nbsp;</td>
                            <td>Date fin</td>
                        </tr>
	...
	$i++;
            ...
            <tr valign="top">
                <td><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=UTIL&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=UTILISATION');">Utilisation</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1501)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <textarea name="UTILISATION" cols="10" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
                <td valign="top">
                    <table cellpadding="0" cellspacing="0">
            ...
            <tr valign="top">
                <td>Pr&eacute;cision sur l&#8217;utilisation <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1502)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    <?php isset($_POST['PRECISION_UTILISATION']) ? $valeur = $_POST['PRECISION_UTILISATION'] : $valeur = $row_rech_objet['PRECISION_UTILISATION']; ?>
                    <textarea name="PRECISION_UTILISATION" cols="10" rows="5" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
                <td valign="top">Pr&eacute;cision sur l&#8217;utilisation seconde <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1505)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    <?php isset($_POST['UTILISATION_SECONDE']) ? $valeur = $_POST['UTILISATION_SECONDE'] : $valeur = $row_rech_objet['UTILISATION_SECONDE']; ?>
                    <textarea name="UTILISATION_SECONDE" cols="10" rows="5" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
            </tr>
        </table>
        ...
        <table cellpadding="3" cellspacing="0" class="centpcent">
            <tr valign="top">
                <td><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=TLIEU&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=LOCALISATION');"><span class="obligatoire">Localisation</span></a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1601)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <input name="LOCALISATION" type="text" class="inputlong40 champobligatoire" value="<?php echo stripslashes($valeur)?>">
                </td>
...
do {
	$result .= $row_auteur['ETAT_CIVIL'];
                    ...
                    <input name="PROPRIETAIRE" class="inputlong40 champobligatoire" type="text" value="<?php echo stripslashes($valeur)?>">
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td valign="bottom">Date d&eacute;but<br>
                                ...
                                <input name="PROPRIETAIRE_DEB_DATE_PATRIMONIALE" type="text"  maxlength="10" class="inputnumerique champobligatoire" value="<?php echo reverseDate($valeur)?>" onBlur="champDat(this);">
                            </td>
                            <td valign="bottom">et</td>
                            <td>Date fin<br>
                ...
                <td><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=TYPRO&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=TYPE_PROPRIETE');"><span class="obligatoire">Type de propri&eacute;t&eacute;</span></a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1618)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <input type="text" name="TYPE_PROPRIETE" class="inputlong40 champobligatoire" value="<?php echo stripslashes($valeur)?>">
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr valign="top">
...
do {
	...
	$i++;
                    ...
                    <input name="SERVICE_GESTIONNAIRE" class="inputlong40 champobligatoire" type="text" value="<?php echo stripslashes($valeur)?>">
                </td>
                <td>Pr&eacute;cision administrative <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1613)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <textarea name="PRECISION_ADMINISTRATIVE" cols="10" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr valign="top">
                <td><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=MACQ&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=MODE_ACQUISITION');"><span class="obligatoire">Mode d&#8217;acquisition</span></a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1603)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <textarea name="MODE_ACQUISITION" cols="10" rows="1" class="textarealong40 champobligatoire"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
	...
	$i++;
                ...
                <td>
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=AFFIXEDATE&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=ANCIENNE_APPARTENANCE_TXT_DATE_PATRIMONIALE');">Affixe</a><br>
	...
	$i++;
                ...
                <td>
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=AFFIXEDATE&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=COMMISSAIRE_PRISEUR_TXT_DATE_PATRIMONIALE');">Affixe</a><br>
                ...
                <td>N&deg; de catalogue <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1616)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    <?php isset($_POST['COMMISSAIRE_PRISEUR_NUMERO_CATALOGUE']) ? $valeur = $_POST['COMMISSAIRE_PRISEUR_NUMERO_CATALOGUE'] : $valeur = $row_rech_objet['COMMISSAIRE_PRISEUR_NUMERO_CATALOGUE']; ?>
	...
	$i++;
                ...
                <td>
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=AFFIXEDATE&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=GALERIE_TXT_DATE_PATRIMONIALE');">Affixe</a><br>
	...
	$i++;
                ...
                <td>
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=AFFIXEDATE&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=DEPOSITAIRE_TXT_DATE_PATRIMONIALE');">Affixe</a><br>
	...
	$i++;
                ...
                <td>
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=AFFIXEDATE&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=ANCIEN_DEPOSITAIRE_TXT_DATE_PATRIMONIALE');">Affixe</a><br>
        ...
        <table border="0" cellspacing="0" class="centpcent">
            <tr>
                <td valign="top">N&deg; dossier <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1808)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <textarea name="NUMERO_DOSSIER" cols="10" rows="1" class="textarealong20"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
                <td valign="top">Accessoire de pr&eacute;sentation <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1802)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <textarea name="ACCESSOIRE_PRESENTATION" cols="10" rows="2" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
            </tr>
        </table>
        <div><a name="DOCUMENTATION" id="DOCUMENTATION"></a></div>
        ...
        <table border="0" cellspacing="0" class="centpcent">
            <tr>
                <td valign="top">Copyright <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1902)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <?php if ($noFiche != 0) { ?>
                    <textarea id="copyright" name="COPYRIGHT" cols="10" rows="3" class="textarealong40"><?php echo $row_rech_objet['COPYRIGHT']?>
</textarea>
                    <?php } else { ?>
                    <textarea id="copyrightNewPage" name="COPYRIGHT" cols="10" rows="3" class="textarealong40"><?php if ($_SESSION['droit']!=60){echo $_SESSION["musee"];} ?></textarea>
                    ...
                    <?php } ?> <?php if ($noFiche != 0) { ?>
                    <input id="codeMuseeHidden" name="CODEMUSEE" type="hidden" value="<?php echo $row_rech_objet['CODEMUSEE']?>">
                    <?php } else { ?>
