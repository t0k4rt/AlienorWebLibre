...
<html lang="fr">
<head>
<title>Formulaire de saisie : Bibliographie</title>
...
<div id="hautDoc">
    <h2>Formulaire de saisie Bibliographie </h2>
</div>
<div id="s-menuDoc">
...
<div id="formulaireDoc" class="saisie">
 	<form name="documentation" action="<?php echo $editFormAction; ?>" method="post" target="_self" enctype="multipart/form-data">
        ...
        <table cellspacing="0" class="centpcent">
            <tr>
                <td valign="top">
                    <label for="label" class="obligatoire"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=TYDOC&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=TYPE_DOCUMENT');">Type de document</a></label>
                ...
                <td valign="top">
                    <label for="label" class="obligatoire">Identifiant</label>
            ...
            <tr>
                <td>Titre du document ou de l&#8217;exposition <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4102)"><img src="../images/infos.gif" alt="Aide en ligne" width="16" height="16" border="0" style="vertical-align:middle"></a><br>
                    ...
                    <textarea name="TITRE_DOCUMENT" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>
                </td>
                <td valign="top">&nbsp;</td>
            </tr>
            <tr>
...
do {
	...
	$i++;
            ...
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=AUT&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=EDITEUR');">&Eacute;diteur</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4107)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    <br>
                    <?php
mysql_select_db($database_alienorweblibre, $alienorweblibre);
...
do {
	...
	$i++;
            ...
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=TLIEU&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=LIEU_EDITION');">Lieu d&#8217;&eacute;dition </a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4108)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    <?php
mysql_select_db($database_alienorweblibre, $alienorweblibre);
	...
	$i++;
            ...
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=DTECH&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=DESCRIPTION_TECHNIQUE');">Description technique</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4105)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    ...
                    <textarea name="DESCRIPTION_TECHNIQUE" rows="4" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>
                </td>
            ...
            <tr>
                <td valign="top">Collection <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4111)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    ...
                    <textarea name="COLLECTION" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>
                </td>
                <td valign="top">Notes libres ou commentaires <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4104)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    <br>
                    <?php isset($_POST['NOTE_LIBRE']) ? $valeur = $_POST['NOTE_LIBRE'] : $valeur = $row_rech_docum['NOTE_LIBRE']; ?>
                    <textarea name="NOTE_LIBRE" rows="3" class="textarealong60"><?php echo stripslashes($valeur)?></textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=DROIT&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=TYPE_DROIT');">Type de Droits</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4115)"><img src="../images/infos.gif" alt="Aide en ligne" width="16" height="16" border="0" style="vertical-align:middle"></a><br>
                    ...
                    <textarea name="TYPE_DROIT" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>
                </td>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=ACCESS&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=ACCESSIBILITE');">Accessibilit&eacute;</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4114)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    ...
                    <textarea name="ACCESSIBILITE" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>
                </td>
            </tr>
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=TLIEU&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=LOCALISATION_DOCUMENT');">Localisation</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4113)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    ...
                    <textarea name="LOCALISATION_DOCUMENT" rows="3" class="textarealong40"><?php echo stripslashes($valeur)?></textarea>
                </td>
                <td valign="top">&nbsp;</td>
            </tr>
        </table>
        ...
        <table cellpadding="3" cellspacing="0" class="centpcent">
            <tr>
                <td>Num&eacute;ro de Support.<a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4215)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    ...
                    <textarea name="NUMERO_SUPPORT" rows="2" class="textarealong20"><?php echo stripslashes($valeur)?></textarea>
                </td>
...
do {
	...
	<input type="hidden" name="MAX_FILE_SIZE" value="<?php echo $_SESSION['max_transfert'] ?>"> 
        ...
        <table class="centpcent">
            <tr valign="top">
                <td colspan="3">Titre du p&eacute;riodique <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4425)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    <br>
                    <?php isset($_POST['TITRE_ENSEMBLE']) ? $valeur = $_POST['TITRE_ENSEMBLE'] : $valeur = $row_rech_docum['TITRE_ENSEMBLE']; ?>
                    <textarea name="TITRE_ENSEMBLE" rows="3" class="textarealong90"><?php echo stripslashes($valeur)?></textarea>
                </td>
            </tr>
            <tr valign="top">
                <td>ISBN <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4426)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a> <br>
                    ...
                    <input name="ISBN" id="ISBN" type="text" size="20" value="<?php echo stripslashes($valeur)?>">
                </td>
                <td>ISSN <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4427)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    ...
                    <input name="ISSN" id="ISSN" type="text" size="20" value="<?php echo stripslashes($valeur)?>">
                </td>
                <td>Cote de l&#8217;ouvrage <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4428)"><img src="../images/infos.gif" width="16" height="16" border="0" alt="Aide en ligne" style="vertical-align:middle"></a><br>
                    ...
                    <input name="COTE" id="COTE" type="text" size="20" value="<?php echo stripslashes($valeur)?>">
                </td>
            </tr>
        </table>
