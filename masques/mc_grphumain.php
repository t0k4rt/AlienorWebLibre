...
<html lang="fr">
<head>
<title>Formulaire de consulation : Groupe humain</title>
...
<div id="haut">
    <h2>Formulaire de consultation Groupe humain </h2>
</div>
<div id="s-menu">
...
<div id="formulaireIMG">
    ...
    <table cellpadding="3" cellspacing="0" class="centpcent">
        ...
        <tr>
            <td class="tddesignation">Nom&nbsp;:</td>
            <td class="tddonnees"><?php echo $row_personne['ETAT_CIVIL']; ?></td>
        </tr>
        <tr>
            <td class="tddesignation">Etat :</td>
        ...
        <tr>
            <td class="tddesignation">Historique :</td>
