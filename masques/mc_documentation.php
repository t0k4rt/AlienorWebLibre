...
<div id="hautDoc">
    <h2>Masque g&eacute;n&eacute;ral de visualisation d&#8217;une documentation</h2>
</div>
<div id="s-menuDoc">
...
<div id="formulaireDoc">
    ...
    <table align="center" class="centpcent">
        <tr>
            <td class="tddonnees">
                ...
                <p align="justify"><em>Pour une facilit&eacute; de compr&eacute;hension certaines rubriques ont des intitul&eacute;s assez longs.</em></p>            </td>
        </tr>
    </table>
    ...
    <table cellpadding="3" cellspacing="0" class="centpcent">
        ...
        <tr>
            <td class="tddesignation">Titre du document ou de l&#8217;exposition :</td>
            <td class="tddonnees"><?php echo $row_docum['TITRE_DOCUMENT']; ?></td>
        </tr>
        <tr>
            <td class="tddesignation">Auteur ou commissaire :</td>
...
$i = 0;
	...
	?><?php
        ...
        <tr>
            <td class="tddesignation">&Eacute;diteur ou organisateur :</td>
            <td class="tddonnees"><?php
mysql_select_db($database_alienorweblibre, $alienorweblibre);
...
$i = 0 ;
    ...
    <table cellpadding="3" cellspacing="0" class="centpcent">
        <tr>
            <td class="tddesignation">Titre d&#8217;ensemble :</td>
