...
<html lang="fr">
<head>
<title>Formulaire de saisie : Vivant</title>
...
<div id="haut">
    <h2>Formulaire de saisie Vivant</h2>
</div>
<div id="s-menu">
        ...
        <table cellpadding="3" cellspacing="0" class="centpcent">
            ...
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=DENO&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=DENOMINATION');">
                    <label for="DENOMINATION">Nom commun </label>
            ...
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=TAXO&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=TAXONOMIE');">Taxonomie</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1110)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
	...
	$i++;
            ...
            <tr>
                <td colspan="2" valign="top">
                    <label for="PRECISION_DECOUVERTE">Pr&eacute;cision sur la collecte</label>
                ...
                <td valign="top" colspan="2"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=AUT&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=COLLECTEUR');">
...
do {
	...
	$i++;
        ...
        <table cellpadding="3" cellspacing="0" class="centpcent">
            ...
            <tr>
                <td colspan="3" valign="top">Description, genre, note <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1308)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
            ...
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=AUT&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=DESCRIPTEUR');">Descripteur</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1413)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    <?php
mysql_select_db($database_alienorweblibre, $alienorweblibre);
...
do {
	...
	$i++;
                    ...
                    <input name="DESCRIPTEUR" class="inputlong40" type="text" value="<?php echo stripslashes($valeur)?>">
                </td>
                <td valign="top">&nbsp;</td>
                <td valign="top">&nbsp;</td>
            </tr>
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=AUT&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=DETERMINATEUR');">D&eacute;terminateur</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1413)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    <?php
mysql_select_db($database_alienorweblibre, $alienorweblibre);
...
do {
	...
	$i++;
                    ...
                    <input name="DETERMINATEUR" class="inputlong40" type="text" value="<?php echo stripslashes($valeur)?>">
                </td>
                <td valign="top">
                    <table cellpadding="0" cellspacing="0">
                        <tr>
...
do {
	...
	$i++;
            ...
            <tr>
                ...
                <td valign="top">
                    <label for="label2">Datation du contexte</label>
            ...
            <tr>
                ...
                <td valign="top">
                    ...
                    <textarea name="DATATION_CONTEXTE" rows="5" class="textarealong40" id="label"><?php echo stripslashes($valeur)?>
                    </textarea>
                </td>
            </tr>
        </table>
