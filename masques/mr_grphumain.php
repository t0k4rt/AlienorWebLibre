...
<html lang="fr">
<head>
<title>Formulaire de recherche : groupe humain</title>
...
<div id="haut">
    <h2>Formulaire de recherche Groupe humain </h2>
</div>
<div id="s-menu">
    <div id="menu"><a href="#IDENTIFICATION">Identification</a> <span class="invisible">|</span> <a href="#ADRESSE">Adresse</a> <span class="invisible">|</span> <span class="invisible">|</span> <a href="#INFORMATIQUE">Gestion&nbsp;informatique</a></div>
    <div id="btnvalid">
    ...
    <form name="fiche" method="post" action="../masques/rep_personne.php">
        ...
        <table cellpadding="3" cellspacing="0" class="centpcent">
            ...
            <tr>
                ...
                <td>
                    <span class="obligatoire"><a href="javascript:FenetreTheso('fs_theso.asp?__GroupId=286&amp;curtheso=AUT&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=ETAT_CIVIL');">Nom  (Autre appellation)</a></span>
            ...
            <tr>
                <td>&Eacute;tat <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,2102)"><img src="../images/infos.gif" alt="Aide en ligne" width="16" height="16" border="0" style="vertical-align:middle"></a></td>
                <td>
        ...
        <table cellpadding="3" CELLSPACING="0" class="centpcent">
            <tr>
                <td colspan="2" class="titre-tbl">ADRESSE</td>
            <tr>
