...
<html lang="fr">
<head>
<title>Formulaire de saisie : Personne morale</title>
...
<div id="haut">
    <h2>Formulaire de saisie : Personne morale</h2>
</div>
<div id="s-menu">
    ...
    <form name="personne" action="<?php echo $editFormAction; ?>" method="post" target="_self">
        ...
        <table cellpadding="3" cellspacing="0" class="centpcent">
            ...
            <tr valign="top">
                ...
                <td>
                    <label for="NOM_MARITAL">Sigle</label>
        ...
        <table cellpadding="3" cellspacing="0">
            <tr>
                <td>
                    <label for="LIEU_NAISSANCE"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=TLIEU&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=LIEU_NAISSANCE');">Lieu de cr&eacute;ation </a></label>
                    <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,2111)"><img src="../images/infos.gif" alt="Aide en ligne" width="16" height="16" border="0" style="vertical-align:middle"></a><br>
                    <br>
                    <?php
	...
	$i++;
            ...
            <td valign="top">
                    <table cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="4">Date de cr&eacute;ation <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,2112)"><img src="../images/infos.gif" alt="Aide en ligne" width="16" height="16" border="0" style="vertical-align:middle"></a><br>
                            </td>
                        </tr>
                        <tr>
            ...
            <tr>
                <td>
                    <label for="LIEU_DECES"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=TLIEU&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=LIEU_DECES');">Lieu de disparition </a></label>
...
do {
	...
	$i++;
                ...
                <td valign="top">
                    <table cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="4">Date de disparition <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,2114)"><img src="../images/infos.gif" alt="Aide en ligne" width="16" height="16" border="0" style="vertical-align:middle"></a><br>
                            </td>
                        </tr>
                        <tr>
                            <td valign="middle">Affixe<br>
            ...
            <tr>
                <td>
                    <label for="LIEU_TRAVAIL"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=TLIEU&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=LIEU_TRAVAIL');">Lieu de d'activit&eacute;</a></label>
...
do {
	...
	$i++;
                ...
                <td valign="top">
                    <table cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="4">Date d'activit&eacute;<br>
                        ...
                        <tr>
                            ...
                            <td valign="middle">Date&nbsp;d&eacute;but<br>
                                ...
                                <input name="LIEU_TRAVAIL_DEBDATEDEBUT" type="text" class="inputnumerique" id="LIEU_TRAVAIL_DEBDATEDEBUT" value="<?php echo stripslashes($valeur)?>">
                            </td>
                            <td valign="middle">et</td>
                            <td valign="middle">Date fin<br>
                                ...
                                <input name="LIEU_TRAVAIL_FINDATEDEBUT" type="text" class="inputnumerique" id="LIEU_TRAVAIL_FINDATEDEBUT" value="<?php echo stripslashes($valeur)?>">
                            </td>
                        </tr>
                    </table>
                </td>
                <td valign="top">
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td valign="middle">Date d&eacute;but<br>
                                <input name="LIEU_TRAVAIL_DEBDATEFIN" type="text" class="inputnumerique" id="LIEU_TRAVAIL_DEBDATEFIN" value="<?php echo stripslashes($valeur)?>">
                            ...
                            <td valign="middle">Date fin<br>
                                ...
                                <input name="LIEU_TRAVAIL_FINDATEFIN" type="text" class="inputnumerique" id="LIEU_TRAVAIL_FINDATEFIN" value="<?php echo stripslashes($valeur)?>">
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <table cellpadding="3" cellspacing="0" class="centpcent">
            <tr>
                <td>
                    ...
                    <br>
                    <?php isset($_POST['LIEU_RESIDENCE']) ? $valeur = $_POST['LIEU_RESIDENCE'] : $valeur = $row_rech_personne['LIEU_RESIDENCE']; ?>
                    <input name="LIEU_RESIDENCE" id="LIEU_RESIDENCE" type="text" class="inputlong40" value="<?php echo stripslashes($valeur)?>">
                </td>
                <td align="left">&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3">
                    <label id="COMMENTAIRE">Activit&eacute;</label>
