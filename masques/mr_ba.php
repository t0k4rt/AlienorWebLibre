...
<html lang="fr">
<head>
<title>Formulaire de recherche : Beaux Arts</title>
...
<div id="haut">
    <h2>Formulaire de recherche Arts </h2>
</div>
<div id="s-menu">
...
<div id="formulaire">
    <form name="fiche" method="post" action="../masques/rep_<?php echo($page)?>.php">
        ...
        <table cellpadding="3" cellspacing="0" class="centpcent">
            <tr>
                <td colspan="9" class="titre-tbl">DONN&Eacute;ES SUR L&#8217;EXECUTION</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="4">
                    <input name="ATTRIBUTION" type="text" class="motcles">
                </td>
