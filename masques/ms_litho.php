...
<html lang="fr">
<head>
<title>Formulaire de saisie : Lithoth&egrave;que</title>
...
<div id="haut">
    <h2>Formulaire de saisie Lithoth&egrave;que </h2>
</div>
<div id="s-menu">
...
<div id="formulaire" class="saisie">
    ...
    <form name="objets" action="<?php echo $editFormAction; ?>" method="post" target="_self">
        ...
        <table cellpadding="3" cellspacing="0" class="centpcent">
            <tr>
                <td valign="top"><span class="obligatoire">Num&eacute;ro d&#8217;inventaire</span> <a href="#" onClick="RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,4122)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    <?php isset($_POST['NUMERO_INVENTAIRE']) ? $valeur = $_POST['NUMERO_INVENTAIRE'] : $valeur = $row_rech_objet['NUMERO_INVENTAIRE']; ?>
                    <input name="NUMERO_INVENTAIRE" type="text" class="motcles" value="<?php echo stripslashes($valeur)?>">
                ...
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=DOMN&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=DOMAINE');"><span class="obligatoire">Domaine</span></a> <a href="#" onClick="RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1101)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <input name="DOMAINE" type="text" class="motcles" value="<?php echo stripslashes($valeur)?>">
                </td>
            </tr>
            <tr>
        ...
        <table cellpadding="3" cellspacing="0" class="centpcent">
            <tr>
                <td valign="top" colspan="3"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=TYPCO&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=TYPE_COLLECTE');">G&icirc;tes (lieu  de collecte secteur g&eacute;ographique)</a><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=TLIEU&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=LIEUX_DECOUVERTE');"></a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1201)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    <?php
...
do {
	...
	$i++;
            ...
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=AUT&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=COLLECTEUR');">
...
do {
	...
	$i++;
                    ...
                    <input name="COLLECTEUR" id="COLLECTEUR" class="inputlong40" type="text" value="<?php echo stripslashes($valeur)?>">
                </td>
                <td valign="top">
                ...
                <td><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=AUT&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=DESCRIPTEUR');">
                    <label for="DESCRIPTEUR">Descripteur</label>
                    </a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1314)"><img src="../images/infos.gif" alt="Aide en ligne" width="16" height="16" border="0" style="vertical-align:middle"></a><br>
                    <br>
                    <?php
mysql_select_db($database_alienorweblibre, $alienorweblibre);
$query_auteur = "SELECT ETAT_CIVIL FROM personne,obj_per WHERE obj_per.INDEX_OBJET =".$noFiche." AND personne.INDEX_PERSONNE = obj_per.INDEX_PERSONNE AND obj_per.QUALIFIANT = 'DESCRIPTEUR' ORDER BY INDEX_OBJ_PER ASC";
$auteur = mysql_query($query_auteur, $alienorweblibre) or die(mysql_error());
$row_auteur = mysql_fetch_assoc($auteur);
$totalRows_auteur = mysql_num_rows($auteur);
$i = 0 ;
...
do {
	...
	$result .= $row_auteur['ETAT_CIVIL'];
	$i++;
} while ($row_auteur = mysql_fetch_assoc($auteur)); ?> <?php isset($_POST['DESCRIPTEUR']) ? $valeur = $_POST['DESCRIPTEUR'] : $valeur = $result; ?>
                    <input name="DESCRIPTEUR" id="DESCRIPTEUR" class="inputlong40" type="text" value="<?php echo stripslashes($valeur)?>">
                </td>
            </tr>
            <tr>
                <td colspan="4" valign="top">
                    <label for="PRECISION_DECOUVERTE">Contexte, position, pr&eacute;cision sur la collecte</label>
                    ...
                    <a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=AUT&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=COLLECTEUR');">
                    <label for="COLLECTEUR"></label>
                    </a></td>
            </tr>
        </table>
        ...
        <table cellpadding="3" cellspacing="0" class="centpcent">
            <tr>
                <td valign="top">
                    ...
                    <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1308)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    <?php isset($_POST['PRECISION_DESCRIPTION']) ? $valeur = $_POST['PRECISION_DESCRIPTION'] : $valeur = $row_rech_objet['PRECISION_DESCRIPTION']; ?>
                    <textarea name="PRECISION_DESCRIPTION" rows="5" class="textarealong60" id="PRECISION_DESCRIPTION"><?php echo stripslashes($valeur)?>
                    </textarea>
                </td>
                <td valign="top">
                    <p><strong>N&#8217;oublier pas de saisir dans cette description, &agrave; travers des phrases :</strong></p>
                    <p><em>Le cortex, la coloration, la trame et la patine;</em><br>
                        <em>L&#8217;aspect, la structure, la texture, le liant et les &eacute;l&eacute;ments figur&eacute;s;</em><br>
                        <em>Et enfin la pal&eacute;ontologie.</em></p>
                </td>
            </tr>
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=AUT&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=DETERMINATEUR');"><span class="obligatoire">
                    <label for="DETERMINATEUR">D&eacute;terminateur</label>
                    </span></a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1311)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    <?php
mysql_select_db($database_alienorweblibre, $alienorweblibre);
$query_auteur = "SELECT ETAT_CIVIL FROM personne,obj_per WHERE obj_per.INDEX_OBJET =".$noFiche." AND personne.INDEX_PERSONNE = obj_per.INDEX_PERSONNE AND obj_per.QUALIFIANT = 'DETERMINATEUR' ORDER BY INDEX_OBJ_PER ASC";
$auteur = mysql_query($query_auteur, $alienorweblibre) or die(mysql_error());
$row_auteur = mysql_fetch_assoc($auteur);
$totalRows_auteur = mysql_num_rows($auteur);
$result = "";
do {
	$result .= $row_auteur['ETAT_CIVIL'];
} while ($row_auteur = mysql_fetch_assoc($auteur)); ?> <?php isset($_POST['DETERMINATEUR']) ? $valeur = $_POST['DETERMINATEUR'] : $valeur = $result; ?>
                    <input name="DETERMINATEUR" id="DETERMINATEUR" class="inputlong40" type="text" value="<?php echo stripslashes($valeur)?>">
                </td>
                <td valign="top">
                    <table cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="4">Date de d&eacute;termination <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1312)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a></td>
                        </tr>
                        <tr>
                            <td><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=DATE&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=ANCIENNE_APPARTENANCE_TXT_DATE_PATRIMONIALE');">Affixe</a><br>
                                <?php isset($_POST['DETERMINATEUR_TXT_DATE_PATRIMONIALE']) ? $valeur = $_POST['DETERMINATEUR_TXT_DATE_PATRIMONIALE'] : $valeur = $row_rech_objet['DETERMINATEUR_TXT_DATE_PATRIMONIALE']; ?>
                                <input name="DETERMINATEUR_TXT_DATE_PATRIMONIALE" type="text" class="inputnumerique" value="<?php echo stripslashes($valeur)?>">
                            </td>
                            <td>Date d&eacute;but<br>
                                <?php isset($_POST['DETERMINATEUR_DEB_DATE_PATRIMONIALE']) ? $valeur = $_POST['DETERMINATEUR_DEB_DATE_PATRIMONIALE'] : $valeur = $row_rech_objet['DETERMINATEUR_DEB_DATE_PATRIMONIALE']; ?>
                                <input name="DETERMINATEUR_DEB_DATE_PATRIMONIALE" type="text" class="inputnumerique" value="<?php echo reverseDate($valeur)?>">
                            </td>
                            <td valign="bottom">et</td>
                            <td>Date fin<br>
                                <?php isset($_POST['DETERMINATEUR_FIN_DATE_PATRIMONIALE']) ? $valeur = $_POST['DETERMINATEUR_FIN_DATE_PATRIMONIALE'] : $valeur = $row_rech_objet['DETERMINATEUR_FIN_DATE_PATRIMONIALE']; ?>
                                <input name="DETERMINATEUR_FIN_DATE_PATRIMONIALE" type="text" class="inputnumerique" value="<?php echo reverseDate($valeur)?>">
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td colspan="2" valign="top"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=TAXO&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=DETERMINATEUR_PARAM');"><span class="obligatoire">Taxonomie d&eacute;termin&eacute;e</span></a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1313)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    <br>
                    <?php isset($_POST['DETERMINATEUR_PARAM']) ? $valeur = $_POST['DETERMINATEUR_PARAM'] : $valeur = $row_rech_objet['DETERMINATEUR_PARAM']; ?>
                    <input  name="DETERMINATEUR_PARAM" type="text" class="inputlong40" id="DETERMINATEUR_PARAM" value="<?php echo stripslashes($valeur)?>">
                </td>
            </tr>
        </table>
        ...
        <table cellpadding="3" cellspacing="0" class="centpcent">
            <tr>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=EPOQU&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=EPOQUE_STYLE');">Attribution g&eacute;ologique (&eacute;poque)</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1408)"> <img src="../images/infos.gif" alt="Aide en ligne" width="16" height="16" border="0" style="vertical-align:middle"></a></td>
                <td valign="top"><a href="javascript:FenetreTheso('fs_theso_hierar-sphinx.asp?__GroupId=286&amp;curtheso=PERIO&amp;curterm=&amp;curindex=&amp;SRC=champ_7&amp;__formGroupid=37&amp;__TableId=32&amp;IdItem=SIECLE_MILLENAIRE');">Mill&eacute;naire</a> <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1407)"><img src="../images/infos.gif" alt="Aide en ligne" width="16" height="16" border="0" style="vertical-align:middle"></a></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td valign="top"><?php isset($_POST['PRECISION_GENESE']) ? $valeur = $_POST['PRECISION_GENESE'] : $valeur = $row_rech_objet['PRECISION_GENESE']; ?>
                    <textarea name="textarea" cols="30" rows="3"><?php echo stripslashes($valeur)?>
                    </textarea>
                </td>
            </tr>
            <tr>
                <td valign="top">
                    ...
                    <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1409)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a></td>
                <td valign="top">&nbsp;</td>
            </tr>
            <tr>
                <td valign="top"><?php isset($_POST['DATATION_CONTEXTE']) ? $valeur = $_POST['DATATION_CONTEXTE'] : $valeur = $row_rech_objet['DATATION_CONTEXTE']; ?>
	...
	$i++;
            ...
            <tr valign="top">
                <td>Pr&eacute;cision sur l&#8217;utilisation <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1502)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <textarea name="PRECISION_UTILISATION" rows="5" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
                <td valign="top">Pr&eacute;cision sur l&#8217;utilisation seconde <a href="javascript:RH_ShowHelp(0,'<?php echo $_SESSION['aide']; ?>',HH_HELP_CONTEXT,1505)"><img src="../images/infos.gif" width="16" height="16" border="0" style="vertical-align:middle" alt="Aide en ligne"></a><br>
                    ...
                    <textarea name="UTILISATION_SECONDE" rows="5" class="textarealong40"><?php echo stripslashes($valeur)?>
</textarea>
                </td>
            </tr>
        </table>
