...
<html lang="fr">
<head>
<title>Formulaire de consultation : Ethnographie</title>
...
<div id="haut">
    <h2>Formulaire de consultation Arts</h2>
</div>
<div id="s-menu">
...
$i = 0;
	...
	?> <span class="tddesignation">Auteur : </span> <?
    ...
    <table cellpadding="3" cellspacing="0" class="centpcent">
        <tr>
            <td class="tddonnees"> <?php
mysql_select_db($database_alienorweblibre, $alienorweblibre);
$query_auteur = "SELECT personne.INDEX_PERSONNE, ETAT_CIVIL FROM personne,obj_per WHERE obj_per.INDEX_OBJET =".$noFiche." AND personne.INDEX_PERSONNE = obj_per.INDEX_PERSONNE AND obj_per.QUALIFIANT = 'ATTRIBUTEUR' ORDER BY INDEX_OBJ_PER ASC";
$auteur = mysql_query($query_auteur, $alienorweblibre) or die(mysql_error());
$row_auteur = mysql_fetch_assoc($auteur);
$totalRows_auteur = mysql_num_rows($auteur);
$i = 0;
	...
	?> <span class="tddesignation">Attributeur : </span> <?
		echo $row_auteur['ETAT_CIVIL']; ?> <?php if ($row_auteur['INDEX_PERSONNE'] != "") { ?> <a href="mc_personne.php?noFiche=<?php echo $row_auteur['INDEX_PERSONNE']; ?>" target="_blank"><img src="../images/changer_base.gif" alt="D&eacute;tails sur l'auteur" width="50" height="20" border="0" style="vertical-align:middle"></a> <?php }
		$i++;
...
$i = 0;
	...
	?> <span class="tddesignation">Attribution : </span> <?
		echo $row_auteur['ETAT_CIVIL']; ?> <?php if ($row_auteur['INDEX_PERSONNE'] != "") { ?> <a href="mc_personne.php?noFiche=<?php echo $row_auteur['INDEX_PERSONNE']; ?>" target="_blank"><img src="../images/changer_base.gif" alt="D&eacute;tails sur l'auteur" width="50" height="20" border="0" style="vertical-align:middle"></a> <?php }
		$i++;
	} while ($row_auteur = mysql_fetch_assoc($auteur)); ?> <br>
                <span class="tddesignation">Date de l'attribution :</span> <?php echo $row_objets['TXT_DATE_ATTRIBUTION']; ?> <?php echo reverseDate($row_objets['DEB_DATE_ATTRIBUTION']); ?> et <?php echo reverseDate($row_objets['FIN_DATE_ATTRIBUTION']); ?></td>
        </tr>
    </table>
    <table cellpadding="3" cellspacing="0" class="centpcent">
        <tr>
...
$i = 0 ;
	do {
		...
		echo $row_docum['IDENTIFIANT'];?> <?php if ($row_docum['INDEX_DOCUMENTATION'] != "") { ?> <a href="mc_documentation.php?noFiche=<?php echo $row_docum['INDEX_DOCUMENTATION'] ?>" target="_blank"><img src="../images/changer_base.gif"  alt="Voir la Bibliographies" width="50" height="20" border="0" style="vertical-align:middle"></a> <?php } $i++;
