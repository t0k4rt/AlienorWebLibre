...
<html lang="fr">
<head>
<title>Formulaire de recherche : Vivant</title>
...
<div id="haut">
    <h2>Formulaire de recherche Vivant </h2>
</div>
<div id="s-menu">
...
<div id="formulaire">
    <form name="fiche" method="post" action="../masques/rep_vivant.php">
        <!-- ZONE IDENTIFICATION -->
        ...
        <table cellpadding="3" cellspacing="0" class="centpcent">
            ...
            <tr>
                <td>
                    <input name="AUTEUR" type="text" class="motcles">                </td>
                <td colspan="4">&nbsp;</td>
            ...
            <tr>
                <td><input name="LIEUX_EXECUTION" type="text" class="motcles"></td>
          <td colspan="4">
                    <input name="SIECLE_MILLENAIRE" type="text" class="motcles">                </td>
                <td>
                ...
                <td>
                    <input name="DEB_DATE_EXECUTION" type="text" class="inputnumerique">                </td>
                <td>et</td>
                <td>
                    <input name="FIN_DATE_EXECUTION" type="text" class="inputnumerique">                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <input name="PRECISION_DATATION" type="text" class="motcles">                </td>
                <td colspan="4">
                    <input name="EPOQUE_STYLE" type="text" class="motcles">                </td>
                <td colspan="4">
                    <input name="PRECISION_GENESE" type="text" class="motcles">                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                <td>
                    <input type="text" name="SOURCE_ORALE_ECRITE">                </td>
                <td>
                ...
                <td>
                    <input name="DEB_DATE_ORIGINAL_COPIE" type="text" class="inputnumerique">                </td>
                <td>et</td>
                <td>
                    <input name="FIN_DATE_ORIGINAL_COPIE" type="text" class="inputnumerique">                </td>
                <td>
                ...
                <td>
                    <input name="DEB_DATE_REPRESENTATION" type="text" class="inputnumerique">                </td>
                <td>et</td>
                <td>
                    <input name="FIN_DATE_REPRESENTATION" type="text" class="inputnumerique">                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="9">
                    <input name="DATATION_CONTEXTE" type="text" class="motcles">                </td>
            </tr>
        </table>
    <br>
        <!-- ZONE UTILISATION -->
